...
[![Build Status](https://travis-ci.org/fonarevvichka/graphql.svg?branch=master)](https://travis-ci.org/fonarevvichka/graphql) [![GoDoc](https://godoc.org/github.com/fonarevvichka/graphql?status.svg)](https://godoc.org/github.com/fonarevvichka/graphql)

Package `graphql` provides a GraphQL client implementation.

For more information, see package [`github.com/fonarevvichka/githubv4`](https://github.com/fonarevvichka/githubv4), which is a specialized version targeting GitHub GraphQL API v4. That package is driving the feature development.
...
```bash
go get -u github.com/fonarevvichka/graphql
```
...
| Path                                                                                   | Synopsis                                                                                                        |
|----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| [example/graphqldev](https://godoc.org/github.com/fonarevvichka/graphql/example/graphqldev) | graphqldev is a test program currently being used for developing graphql package.                               |
| [ident](https://godoc.org/github.com/fonarevvichka/graphql/ident)                           | Package ident provides functions for parsing and converting identifier names between various naming convention. |
| [internal/jsonutil](https://godoc.org/github.com/fonarevvichka/graphql/internal/jsonutil)   | Package jsonutil provides a function for decoding JSON into a GraphQL query data structure.                     |
